    ...
    <div>
        ...
        <ul class="nav nav-tabs" role="tablist">
            ...
            foreach ($productsDataProvider->getModels() as $tab_name => $products):
                $tab_model = OrderBlank::findOne(['number' => $tab_name]);
                $weekDay = \app\components\DateHelper::getWeekDay($model->target_date);
                if ($tab_model->canOrderByWeekDay($weekDay)) :
                ?>
                <li role="presentation">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-sm-12 tab-nomenclature-list">
                                    <?= $this->render('/order-new/_nomenclature', [
                                        'model' => $model,
                                        'blank' => $tab_model,
